...
class MOSFET:
    ...
    def Corrente_modulacaotriodo(self,MOS):
    ...
    def Corrente_modulacaosat(self,MOS):
    ...
    def transcondutancia_sat(self,MOS):
        gm = math.sqrt(2*MOS.UO*MOS.C_ox*(MOS.W/MOS.L)*MOS.I_D)
        return gm

    # ------------------- Função para plotar os gráficos --------------------------------------------------------------
    def grafico(self,MOS):


        #Variaçao de Vds de 0 até 3.3
        Vds_list = np.arange(0,3.3,0.001)
        
        #Variaçao de Vgs de 0 até 3.3
        Vgs_list = np.arange(0,3.3,0.001)
        ...
        for MOS.V_GS in vg: #Plota o gŕafico para os diferentes valores de Vg
            id_list = [MOS.Corrente_triodo(MOS)if (MOS.V_DS < MOS.V_GS - MOS.V_TH) else MOS.Corrente_sat(MOS) for MOS.V_DS in Vds_list] #Calcula a corrente para trido e saturação para Vds de 0 até 3.3
        ...
        for MOS.V_GS in vg: #Plota o gŕafico para os diferentes valores de Vg
            id_modulacao = [MOS.Corrente_modulacaotriodo(MOS)if (MOS.V_DS < MOS.V_GS - MOS.V_TH) else MOS.Corrente_modulacaosat(MOS) for MOS.V_DS in Vds_list] #Calcula a corrente para trido e saturação para Vds de 0 até 3.3 considerando o efeito de modulação de canal
        ...
        id_trans = [MOS.Corrente_triodo(MOS)if (MOS.V_DS < MOS.V_GS - MOS.V_TH) else MOS.Corrente_sat(MOS) for MOS.V_DS in Vds_list] #Define o valor da corrente 
        gm_list = [MOS.transcondutancia_sat(MOS)for MOS.I_D in id_trans] #Define o valor da Trancondutância para os diferentes valores de corrente
        ...
        id_liss = [MOS.Corrente_corte(MOS)if (MOS.V_GS < MOS.V_TH) else MOS.Corrente_triodo(MOS)if (MOS.V_DS < MOS.V_GS - MOS.V_TH) else MOS.Corrente_sat(MOS) for MOS.V_GS in Vgs_list] #Calcula a corrente para trido e saturação para Vgs de 0 até 3.3
